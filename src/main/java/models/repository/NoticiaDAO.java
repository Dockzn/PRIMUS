...
public class NoticiaDAO {
    ...
    /**
     * Lê os dados de uma notícia no sistema.
     * @param noticia A notícia cujos dados serão lidos.
     * @throws SQLException Se ocorrer um erro ao acessar o banco de dados.
     * Ainda vai ser implementado.
     */
    ...
    /**
     * Edita os dados de uma notícia no sistema.
     * @param noticia A notícia cujos dados serão editados.
     * @throws SQLException Se ocorrer um erro ao acessar o banco de dados.
     * Ainda vai ser implementado.
     */
     ...
     * @param noticia A notícia a ser removida.
     * @throws SQLException Se ocorrer um erro ao acessar o banco de dados.
     * Ainda vai ser implementado.
     */
